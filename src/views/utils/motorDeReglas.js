...
const crearReglasDeMotos = (engine) => {
    ...
    //R3
    CrearReglaSimple(engine, 'Recreativo', 'Alta', 'Baja', '400NK, 302S, 500R, Dominar 400', 'alta experiencia, se busca lo mas divertido posible con un presupuesto bajo.');
    //R4
    ...
    //R6
    CrearReglaSimple(engine, 'Recreativo', 'Medio', 'Baja', '400NK, 302S, 500R, CBR300, CB300R, Dominar 400', 'Experiencia media, se busca algo que tenga como mucho 120 HP con un presupuesto bajo.');
    //R7
    ...
    //R9
    CrearReglaSimple(engine, 'Recreativo', 'Baja', 'Baja', 'Rouser 200, DUKE 200, CB250, Svartpilen 200, 300NK, 300R, LEONCINO 250, FZ25, Dominar 250', 'Al tener baja experiencia, se buscan motos que tengan a lo sumo 50 HP, con un presupuesto bajo.');
    //R10
    ...
    //R12
    CrearReglaSimpleSinExperiencia(engine, 'Competicion', 'Baja', 'YZF-R3, NINJA 400, RC390, RC200, XTZ 250, XR250, KX250, YZ125', 'Para uso competitivo existen dos principales ramas, las motos de velocidad o las motos de tierra, ambas se encuentra en espectros separados, una apunta a mayor potencia con 4 cilidros y la otra a mayor torque con un monocilindrico. En este caso al ser de presupuesto medio, se asume que se apunta a una categoria de entrada a cada tipo de competicion.');
    //R13
    ...
    //R15
    CrearReglaSimpleSinExperiencia(engine, 'Laboral', 'Baja', 'AX100, GN125, Crypton, Wave, Boxer, V15', 'Se buscan las motos mas economicas, tanto para comprar como para mantener.');
    //R16
    CrearReglaSimple(engine, 'Viajes', 'Alta', 'Alta', 'SUPER TENERE, FJR 1300, VSTROM1050MT, Ninja 1000SX, S1000XR, R18, R1250GS, Multristrada 1260, Versys 1000, AFRICA TWIN', 'Se ofrece la gama mas alta de las motos viajeras');
    //R17
    CrearReglaSimple(engine, 'Viajes', 'Alta', 'Medio', 'Norden 901, MT-09 GT, TENERE 700, 790 ADVENTURE, Scrambler 800, Multristrada 950, F850GS, VSTROM 650MT', 'Alta experiencia, la mayor comodidad posible con un presupuesto medio');
    //R18
    CrearReglaSimple(engine, 'Viajes', 'Alta', 'Baja', 'XRE300, Versys 300, 390 ADVENTURE, 250 ADVENTURE, 650MT, 650GT, 800MT, TRK502, 650DS,500DS', 'Alta experiencia, la mayor comodidad posible con un presupuesto bajo');
    //R19
    CrearReglaSimple(engine, 'Viajes', 'Medio', 'Alta', 'REBEL 1100, Versys 650, Vulcan 900, Scrambler 400, TC MAX, CPX', 'Se busca lo mejor posible que aun sea manejable por alguien con experiencia media, por lo general, motos viajeras de menor peso para que sean mas manejables.');
    //R20
    CrearReglaSimple(engine, 'Viajes', 'Medio', 'Medio', 'Vulcan S, Versys 650, KLR 650, LEONCINO 500, Ninja 650, NC750X, CB500X, REBEL 500, 502C, CUX', 'Se busca una gama intermedia que sea manejable por alguien con experiencia media, por lo general, motos viajeras de menor peso para que sean mas manejables.');
    //R21
    CrearReglaSimple(engine, 'Viajes', 'Medio', 'Baja', 'TRK251, REBEL 300, 300DS, 300 Rally, Avenger, IMPERIALE 400, Himalayan 400, TC', 'Se buscan los modelos que permitan realizar viajes largos con un presupuesto reducido y que sea manejable por alguien con experiencia media, por lo general, motos viajeras de menor peso para que sean mas manejables');
    ...
    CrearReglaTroncal(engine, 'Viajes', true, true)
}
