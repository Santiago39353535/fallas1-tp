...
const crearReglasDeMotos = (engine) => {
    //R1
    CrearReglaSimple(engine, 'Recreativo', 'Alta', 'Alto', 'MT-10, CB1000R, Diavel 1200, H2', 'Al tener alto presupuesto y alta experiencia para uso recreativo cualquier modelo esta permitido sin limite de HP. Basicamente va a depender de los gustos personales de cada usuario.');
    //R2
    ...
    //R4
    CrearReglaSimple(engine, 'Recreativo', 'Medio', 'Alto', 'MT-09, XSR900, GSX750, Z900, Z900RS, 701 Supermoto, DUKE 790, Hypermotard 950', 'Alto presupuesto, experiencia media, se busca algo que tenga como mucho 120 HP sin importar su precio.');
    //R5
    ...
    //R7
    CrearReglaSimple(engine, 'Recreativo', 'Baja', 'Alto', 'DUKE 390, MT-03, Ninja 400, Z400, CB500F, YZF-R3, Svartpilen 401, Vitpilen 401', 'Al tener baja experiencia, se buscan motos que tengan a lo sumo 50 HP, sin importar su precio, por lo que se apunta a las motos mas premium de este segmento.');
    //R8
    ...
    //R10
    CrearReglaSimpleSinExperiencia(engine, 'Competicion', 'Alto', 'YZF-R1, CBR1000RR, ZX10R, Panigale V4, S1000RR, YZ450F, CRF450R, KX450, 350 SX, FE 450, RMZ450, TE 300 (2T)', 'Para uso competitivo existen dos principales ramas, las motos de velocidad o las motos de tierra, ambas se encuentra en espectros separados, una apunta a mayor potencia con 4 cilidros y la otra a mayor torque con un monocilindrico.');
    //R11
    ...
    //R13
    CrearReglaSimpleSinExperiencia(engine, 'Laboral', 'Alto', 'moFZ 160, XR190, CB 190, XTZ 125, 180S, NMAX, PCX150to12', 'Las motos para uso laboral estan asociadas inherentemente al bajo costo de mantenimiento, pero al tener presupuesto alto, se busca tener la mayor comodidad posible en la moto.');
    //R14
    ...
    //R16
    CrearReglaSimple(engine, 'Viajes', 'Alta', 'Alto', 'moto15', '');
    //R17
